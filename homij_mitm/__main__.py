...
def main(cert_file, key_file, log_folder, basen_id, influxdb_url, influxdb_token, influxdb_org, influxdb_bucket, port):
    logging.basicConfig(
    ...
    homij_forwarder = HomijForwarder(
        basen_id=basen_id, send_measurement=influxdb_client.send_measurement, log_filename=log_filename
    )
